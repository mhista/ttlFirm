...
const PageHeader = ({text, text2, image, subAreas=[]}) => {
  ...
  return (
    <div className={`relative w-full h-[310px] sm:h-[300px] md:h-[340px]`}>
      ...
      ></img>
    <div className={`w-full relative h-[300px] sm:h-[300px] md:h-[400px] flex flex-col-reverse sm:flex-row-reverse items-center justify-center sm:items-center md:gap-8 pt-20 sm:pt-[10px]  sm:pl-9 md:pl-0 lg:pl-9 md:px-5`}>
