...
const PracticeContainer = ({image1, image2, title, subtitle}) => {
  ...
  <Link href="#">
  <div className={`${isHovered ?"text-white bg-amber-600 opacity-70":"text-black bg-white"} h-[290px] w-[300px] sm:w-[350px] shadow-lg  flex flex-col items-start justify-around gap-4 px-3 sm:pr-0 sm-:pl-10  py-8`}>
        <Image
          className=""
