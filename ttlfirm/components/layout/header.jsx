...
const Header = ({}) => {
  ...
  return (
    <div className={`relative w-full h-[630px] sm:h-[500px] md:h-[600px]`}>
      ...
      ></img>
      <div className="w-full relative h-[630px] sm:h-[500px] md:h-[600px] flex flex-col sm:flex-row justify-center sm:items-center gap-7 pt-9 sm:pt-16 sm:pl-9 md:pl-0 lg:pl-9">
