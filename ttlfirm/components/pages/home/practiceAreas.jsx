...
const PracticeArea = () => {
  return (
    <div className="relative section1 w-full flex flex-col justify-around items-center gap-5 md:gap-10 z-30 py-32">
   ...
   <PracticeContainer image1={'/assets/images/inju.jpg'}  title={'Personal Injury'} aos={"fade-right"} id={1} subAreas={['Car Crash', 'Slip and Fall', 'Dog Bites']}
    ...
    subtitle={'A workplace injury can disrupt your life in ways you never anticipated. From physical pain and mounting medical bills to lost wages and job insecurity, the aftermath'}/>
     <PracticeContainer image1={'/assets/images/munic.jpg'}  title={'Municipal Matters'} aos={"zoom-in"} id={4} subAreas={[ 'Traffic Ticket Lawyer']}
