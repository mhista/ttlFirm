...
const PracticeArea = () => {
  return (
   ...
   <PracticeContainer image1={'/assets/images/injury.jpg'}  title={'Personal Injury'} aos={"fade-right"}
    ...
    <PracticeContainer image1={'/assets/images/immig.jpg'}  title={'Immigration'} aos={"zoom-in"}
    subtitle={'lorem Ipsum is simply dummy text of the printing and typesettin industry that remains essentially unchanged after Print License Version'}/>
    <PracticeContainer image1={'/assets/images/work.jpg'}  title={'Workers Compensation'} aos={"fade-left"}
    subtitle={'lorem Ipsum is simply dummy text of the printing and typesettin industry that remains essentially unchanged after Print License Version'}/>
     <PracticeContainer image1={'/assets/images/muni.jpg'}  title={'Municipal Matters'} aos={"zoom-in"}
    subtitle={'lorem Ipsum is simply dummy text of the printing and typesettin industry that remains essentially unchanged after Print License Version'}/>
   </div>
