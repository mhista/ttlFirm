...
const HomeHero = ({height1 = "1200", height2="550", height3})=>{
    ...
    return (
        <div className={`w-full relative h-[1260px] sm:h-[600px] md:h-[900px] flex flex-col-reverse sm:flex-row-reverse items-start justify-center sm:items-center gap-7 md:gap-8 pt-20 sm:pt-[100px] px-5 sm:pl-9 md:pl-0 lg:pl-9 md:px-5`}>
        <div className=" flex flex-col md:flex-row items-center justify-center md:items-end w-full md:w-[full] md:pr-10 gap-5">
          <Image
        ...
        <div
          className={`text-white  flex flex-col items-start justify-center md:pl-8  w-full gap-5 z-40 md:pt-20 lg:pt-14`}
        >
