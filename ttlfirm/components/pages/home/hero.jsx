  ...
  return (
    ...
    >
      <div className=" flex flex-col items-center justify-center  w-full md:w-[full] md:pr-10 gap-5">
        ...
        <Link
          href={"/profile"}
          className="z-40 font-lora border p-2   text-xl sm:text-base text-white md:text-2xl"
        >
      ...
      >
        ...
        <h1
          ...
          data-aos="fade-up"
        >
          Trusted <span className="text-amber-600">New Jersey</span> Law firm
          delivering the best legal outcomes
        </h1>
        {/* <h1
            className="font-lora  text-2xl sm:text-2xl md:text-4xl uppercase font-bold "
            data-aos="fade-up"
        ...
        <p
          ...
          data-aos="zoom-in-up"
        >
          We are a dedicated law firm in New Jersey committed to providing
          exceptional legal representation rooted in compassion, diligence, and
          integrity. Our expertise lies in personal injury law, where we
          relentlessly pursue justice and fair compensation for individuals who
          have suffered harm due to the negligence of others. Beyond personal
          injury, our firm offers comprehensive legal services in immigration
          law, workers' compensation, municipal court matters, and a broad
          spectrum of additional practice areas.
        </p>
