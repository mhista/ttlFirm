  ...
  return (
    <div className="relative w-full flex flex-col items-center gap-5 md:px-20 lg:px-24 py-10 md:py-20 ">
      ...
      <div className="flex flex-col sm:flex-row w-full items-center justify-center gap-7">
        <NumbersContainer title={"1000+"} subtitle={"Clients Consultation"} aos={"zoom-in"} duration={"1000"}/>
        <NumbersContainer title={"90+"} subtitle={"Successful cases"} aos={"zoom-in"} duration={"1100"}/>
        <NumbersContainer title={"1500+"} subtitle={"Happy clients"} aos={"zoom-in"} duration={"1200"}/>
      </div>
    </div>
  );
};
