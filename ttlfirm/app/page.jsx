...
const Home = () => {
  return (
    ...
    <div className="absolute z-[70]  w-[85%] md:w-[60%] justify-center items-center right-[28px] sm:right-[48px] md:right-11 lg:right-14 top-[-30px] sm:top-[-60px] md:top-[-90px] md:pr-4 bg-zinc-100  flex flex-row shadow-2xl border-amber-600 border-opacity-90 border-t-[3px] gap:3 md:gap-5 rounded-sm">
