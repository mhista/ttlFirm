  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        <div className="absolute z-[70] w-[85%] lg:w-[50%] justify-center items-center right-[28px] sm:right-[48px] lg:left-10 top-[1030px] sm:top-[650px] md:top-[780px] lg:top-[820px] md:pr-4 bg-zinc-100 flex flex-row shadow-2xl border-amber-600 border-opacity-90 border-t-[3px] gap:3 md:gap-5 rounded-sm">
